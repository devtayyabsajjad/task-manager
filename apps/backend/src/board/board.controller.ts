...
export class BoardController {
  ...
  @Get('boards/:id/statistics') // GET /boards/:id/statistics
  @HttpCode(HttpStatus.OK)
  getBoardStatistics(@Param('id') id: string): Promise<any> | never {
    return this.boardService.getBoardStatistics(id);
  }
